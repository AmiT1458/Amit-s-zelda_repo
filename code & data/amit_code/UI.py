...
class UI():
    ...
    def show_exp(self,exp):
        ...
        pygame.draw.rect(self.display_surface, UI_BG_COLOR, text_rect.inflate(15, 15),3)
    ...
    def weapon_overlay(self,weapon_index,has_switch):
        bg_rect = self.selection_box(10, 630,has_switch)
        weapon_surface = self.weapon_graphics[weapon_index]
        weapon_rect = weapon_surface.get_rect(center=bg_rect.center)
        self.display_surface.blit(weapon_surface,weapon_rect)

    def magic_overlay(self,magic_index,has_switch):
        bg_rect = self.selection_box(80, 635, has_switch)
    ...
    def display(self,player):
        ...
        #self.selection_box(85, 635)  # magic
